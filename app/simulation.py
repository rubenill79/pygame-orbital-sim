...
class Simulation():
    def __init__(
        ...
        # fullscreen: booleano – si es verdadero, anula automáticamente las dimensiones
    ...
    def start(self):
        ...
        if(self.scenario == 1): self.sim_rate = 0.025
        ...
        while 1:
            ...
            self.window.blit(date_display, (20, 20))
